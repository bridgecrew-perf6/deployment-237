      ...
      <div>
        <div className="flex flex-wrap -mx-3 chivo">
          ...
          <div className="lg:w-1/2 xl:w-1/2 w-full px-3 mb-5">
            ...
            <div className="flex">
              <div className="w-10 z-10 pl-1 text-center pointer-events-none flex pt-2 justify-center">
              ...
              <textarea
                ...
                id="name"
                // onChange={handleChange}
                className="w-full h-32 text-theme -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-innerBG"
