      ...
      <div className="bg-white rounded-xl p-4 dashboard-top-space">
        ...
        <div className="flex">
          <div className="w-full px-3">
            <button
              className="block w-full playfair max-w-xs mx-auto bg-gradient-to-r from-primary to-secondary hover:to-primary font-bold hover:from-secondary text-white rounded-lg px-3 py-3 font-semibold focus:outline-none"
              onClick={handleClick}
            >
              Reset Password
            </button>
