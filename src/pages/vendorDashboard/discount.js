  ...
  return (
    <div className="w-full h-auto rounded-xl shadow-lg bg-white p-4">
      <div className="flex flex-row justify-between">
        <div>
          <div className="uppercase font-medium text-secondary">Discount</div>
          <div className=" font-medium text-gray-400 mb-2">All discounts</div>
        </div>
        <div>
          <button
              ...
              {blog.map((blog) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="capitalize">20%</span>
                    </TableCell>
                ...
                <div className="flex flex-col -mx-3 chivo">
                  ...
                  <div className="w-full px-3 mb-3">
                    ...
                    <div className="flex">
                      ...
                      /> */}
                      <ReactQuill name="about" theme="snow" value={filteredData.description} onChange={(e) => handleEditor(e)}
